...
var _performanceRelayer = _interopRequireDefault1(__webpack_require__(659));
    ...
    _createClass(Container, [
        ...
        },
        {
            ...
            value: function componentDidMount() {
                ...
                initialData.page !== "/404" && initialData.page !== "/_error" && (initialData.isFallback || initialData.nextExport && ((0, _isDynamic).isDynamicRoute(router.pathname) || location.search || false) || initialData.props && initialData.props.__N_SSG && (location.search || false))) {
...
function _initialize() {
    _initialize = _asyncToGenerator(_runtimeJs.default.mark(function _callee() {
...
function AppContainer(param) {
    ...
    return /*#__PURE__*/ _react.default.createElement(Container, {
        ...
        value: {"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/mattak-swikt/_next/image","loader":"default","experimentalLayoutRaw":false}
    }, children))));
}
...
var RSCComponent;
if (false) { var ServerRoot, rscCache, nextServerDataLoadingGlobal, DOMContentLoaded, initialServerDataFlushed, initialServerDataLoaded, initialServerDataWriter, initialServerDataBuffer, encoder, ref1, createFromFetch, createFromReadableStream, getCacheKey, useServerResponse, fetchFlight, createResponseCache, nextServerDataRegisterWriter, nextServerDataCallback; }
var lastAppProps;
...
var PageLoader = /*#__PURE__*/ function() {
   ...
   */ key: "getDataHref",
            value: function getDataHref(param) {
                var href = param.href, asPath = param.asPath, ssg = param.ssg, flight = param.flight, locale = param.locale;
                var _this = this;
...
var RefreshContext = (0, _react).createContext(function(_props) {});
